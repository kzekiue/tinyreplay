...
type IconAttrs = Record<string, number | string>;
type IconNode = [IconTag, IconAttrs][];
...
function createLucideIcon(iconName: string, iconNode: IconNode) {
  const Component = forwardRef<SVGSVGElement, IconProps>(
    (
      ...
      const iconChildren: ReactNode[] = iconNode.map(([tag, attr]) =>
        createElement(tag, attr),
      );
      if (children) iconChildren.push(children);
...
export const Clipboard = createLucideIcon('clipboard', [
  ['rect', { width: '8', height: '4', x: '8', y: '2', rx: '1', ry: '1', key: '1' }],
  ['path', { d: 'M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2', key: '2' }],
]);
